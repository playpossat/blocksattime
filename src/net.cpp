...
void ThreadGetMyExternalIP(void* parg)
{
    ...
    RenameThread("satoshimadness-ext-ip");
...
void ThreadSocketHandler(void* parg)
{
    ...
    RenameThread("satoshimadness-net");
...
void ThreadMapPort(void* parg)
{
    ...
    RenameThread("satoshimadness-UPnP");
...
void ThreadMapPort2(void* parg)
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "satoshimadness " + FormatFullVersion();
#ifndef UPNPDISCOVER_SUCCESS
        /* miniupnpc 1.5 */
...
void ThreadDNSAddressSeed(void* parg)
{
    ...
    RenameThread("satoshimadness-dnsseed");
...
void ThreadDumpAddress(void* parg)
{
    ...
    RenameThread("satoshimadness-adrdump");
...
void ThreadOpenConnections(void* parg)
{
    ...
    RenameThread("satoshimadness-opencon");
...
void ThreadMessageHandler(void* parg)
{
    ...
    RenameThread("satoshimadness-msghand");
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. satoshimadness is probably already running."), addrBind.ToString().c_str());
        else
...
void StartNode(void* parg)
{
    ...
    RenameThread("satoshimadness-start");
